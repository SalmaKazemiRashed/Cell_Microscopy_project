...
#define all images
with open('/proj/berzelius-2021-21/users/klara/Segmentation/data/4_filelists/'+plateNr+'_names.txt') as image_list:
...
for image_name in all_images:
    # Load predictions
    pred_filename = os.path.join("/proj/berzelius-2021-21/users/klara/Segmentation/plate_script/"+plateNr+"/out/segm/", image_name)
    ...
    #####################################################################################
pred_obj.to_csv("/proj/berzelius-2021-21/users/klara/Segmentation/plate_script/"+plateNr+'/'+plateNr+'.csv',index=False)