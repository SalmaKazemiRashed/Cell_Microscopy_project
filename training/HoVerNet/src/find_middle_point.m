% this script is written by Leo and Marisa, former master students for creating .mat files for each .png image adding extra info of centroid points of each object
% This script is run in MATLAB for all 150 images (50 Aits images and 100 BBBC images for training hovernet)
...
%     imshow(im_raw);
    ...
    im = imread(append("raw_anno/", file));
